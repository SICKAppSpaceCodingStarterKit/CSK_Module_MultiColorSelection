-- Block namespace
local BLOCK_NAMESPACE = "MultiColorSelection_FC.OnNewResult"
  ...
  local function localCallback()
    ...
    if cbFunction ~= nil then
      ...
      if mode == 'TOTAL_SUBRESULTS' then
        Script.callFunction(cbFunction, 'CSK_MultiColorSelection.OnNewStringResult' .. tostring(instance))
      else
        Script.callFunction(cbFunction, 'CSK_MultiColorSelection.OnNewResult' .. tostring(instance))
      end
